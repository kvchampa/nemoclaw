...
usage() {
  ...
  printf "  ${C_DIM}Privileges:${C_RESET}\n"
  printf "    This installer does not require root or sudo.\n"
  printf "    Node.js is installed via nvm and NemoClaw via npm, both in user-local directories.\n"
  printf "    Prerequisites (Docker, OpenShell) must be installed separately and may need elevated privileges.\n\n"
